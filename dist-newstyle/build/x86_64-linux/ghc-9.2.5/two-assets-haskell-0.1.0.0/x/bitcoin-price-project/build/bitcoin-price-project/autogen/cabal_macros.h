...
/* package two-assets-haskell-0.1.0.0 */
#ifndef VERSION_two_assets_haskell
#define VERSION_two_assets_haskell "0.1.0.0"
#endif /* VERSION_two_assets_haskell */
#ifndef MIN_VERSION_two_assets_haskell
#define MIN_VERSION_two_assets_haskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_two_assets_haskell */
/* package Chart-1.9.4 */
...
#define CURRENT_COMPONENT_ID "two-assets-haskell-0.1.0.0-inplace-bitcoin-price-project"
